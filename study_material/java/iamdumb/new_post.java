...
public class new_post
{
    public static void main (String [] args)
    {
        ...
        for(int i = 0; i < Q.length(); i++)
        {
            ...
            {
                if( (comp( tos , scn) == 1) ) //if precedence is lower than TOS or TOS is open parenthesis push scanned symbol directly to stack
                {
                    S += scn;
                    s_p++;
                }
