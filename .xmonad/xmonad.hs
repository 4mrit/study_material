...
myStartupHook = do
  ...
  spawnOnce "picom"
  --spawn "wal -i /home/amrit/rescources/wallpapers/ -o wal-set --saturate 1.0"
...
myKeys c =
  ...
  , ("M-S-r", addName "Restart XMonad"         $ spawn "xmonad --restart && wal -i /home/amrit/rescources/wallpapers/ --saturate 1.0")
  ...
  , ("<XF86AudioMicMute>", addName "Toggle audio mute"   $ spawn "pactl set-source-mute 1 toggle")
  , ("<XF86AudioMute>", addName "Toggle audio mute"   $ spawn "pactl set-sink-mute 0 toggle")
  , ("<XF86AudioLowerVolume>", addName "Lower vol"    $ spawn "pactl set-sink-volume 0 -5%")
  , ("<XF86AudioRaiseVolume>", addName "Raise vol"    $ spawn "pactl set-sink-volume 0 +5%")
  , ("<XF86MonBrightnessUp>", addName "raise brightness"    $ spawn "backlight_control +5")
  , ("<XF86MonBrightnessDown>", addName "lowe brightness"    $ spawn "backlight_control -5")
  , ("<Print>", addName "Take screenshot (dmscripts)" $ maimcopy)  
  , ("M-<Print>", addName "Take screenshot (dmscripts)" $ maimsave)  
  , ("M-<Delete>", addName "turn off monitor" $ spawn "sleep 1; xset dpms force off")
  ]
